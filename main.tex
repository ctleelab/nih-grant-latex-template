...
\usepackage{lua-ul} % \underLine, \highLight, and \strikeThrough. 
...
% With LuaTeX, lipsum requires babel to get proper hyphenation
...
\titlespacing*{\part}{0pt}{4\mysecskip}{\myaftersep}
...
% Split mini page for cover pages
\newcommand{\splitminipage}[2]{\begin{minipage}[t][][t]{0.25\linewidth}
#1
\end{minipage}
\hfill
\begin{minipage}[t][][t]{0.74\linewidth}
#2
\end{minipage}}


% Hack to introduce custom labels for sections
% Maybe better to define custom counters and use those instead
% \customlabel{sec:task}{[task][1][1]1.1}{Task 1.1}
\newcommand{\customlabel}[3]{%
    \protected@write\@auxout{}%
        {\string\newlabel{#1}{{#3}{\thepage}{#2}{#1}{}}}%
    \@bsphack%
...
% Proposal metadata... 
%---------------------------------
\newcommand{\ProposalTitle}{WORKING TITLE}

\newcommand{\AimOneText}{AIM 1}

\newcommand{\AimTwoText}{AIM 2}

\newcommand{\AimThreeText}{AIM 3}
...
\newpage
\subfile{sections/project_summary.tex}
